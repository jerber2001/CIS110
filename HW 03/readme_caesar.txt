...
I was first unable to determine if my score frequency function was 
working properly using the correct key. Later, I struggled to obtain 
the correct character key code, where the output was no protocol 
recognized. 
...
Functions allow for repetitive tasks with variable inputs to be 
efficiently called when needed. Functions can be implemented when needed
through thier call.
...
Caesar Ciphers have 26 keys, which can be broken by any modern computer
fairly quickly, when given the correct program.
